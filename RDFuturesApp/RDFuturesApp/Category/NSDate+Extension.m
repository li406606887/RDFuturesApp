 ...
 *  是否大于五分钟
 */
+ (BOOL)isAfterFiveMinute:(NSDate *)date {
    // 2014-05-01
    NSDate *nowDate = [[NSDate date] dateWithYMD];
    // 获得nowDate和selfDate的差距
    NSCalendar *calendar = [NSCalendar currentCalendar];
    NSDateComponents *cmps = [calendar components:NSCalendarUnitMinute fromDate:date toDate:nowDate options:0];
    return cmps.minute >4;
}
/**
 *  是否为昨天
 */
