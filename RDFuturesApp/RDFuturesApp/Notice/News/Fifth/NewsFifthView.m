...
@interface NewsFifthView()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic,strong) NewsViewModel * viewModel;
@property (nonatomic,strong) UITableView * tableView;
@property(nonatomic,assign) int page;
@end

@implementation NewsFifthView
...
-(void)bindViewModel{
    @weakify(self)
    [self.viewModel.refreshFifthSubject subscribeNext:^(id x) {
        @strongify(self)
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.model = self.viewModel.fifthDataArray[indexPath.row];
    return cell;
}

-(NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    return self.viewModel.fifthDataArray.count;
}
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    NewsListModel * model = self.viewModel.fifthDataArray[indexPath.row];
